...
Set:
1)unordered collection because order in a set depends on implementation classes.
2)set does not allow the duplicate values.
3)cannot have get() in set.

list name={2,3,4,5,2,4,6}-->index 4--->2
    set---->{2,3,4,5,6}---->6

implementation classes in Set:
1)HashSet--->maintains a random order of elements.
